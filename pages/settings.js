        ...
        <div className={styles.settings__formContent}>
          <div className={styles.settings__formContentSettings}>
            <div className={styles.settings__formContentSettingsAccount}>
              <div
                className={styles.settings__formContentSettingsAccountSettings}
              >
                <TextField
                  id="outlined-basic"
                  label="Emailul Tau"
            ...
            <div className={styles.settings__formContentSettingsPicker}>
              ...
              <div style={{ display: 'flex' }}>
                ...
                &#160;
                <Alert severity="info">
                  Stiind media ta la bac te putem avertiza daca ai sanse mici de
                  intrare la o anumita facultate.
                </Alert>
              </div>
            </div>
          </div>
